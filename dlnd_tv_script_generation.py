...
def get_batches(int_text, batch_size, seq_length):
    ...
    batch_length = n_batches*seq_length

    for i in range(n_batches):
        x_batch = []
        y_batch = []
        for ii in range(batch_size):
            x_batch.append(int_text[ii*batch_length + i*seq_length: ii*batch_length + i*seq_length + seq_length])
            y_batch.append(int_text[ii*batch_length + i*seq_length + 1: ii*batch_length + i*seq_length+ seq_length + 1])
        output.append([x_batch,y_batch])
